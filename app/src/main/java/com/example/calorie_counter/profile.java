...
public class profile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EditText weight_txt_update=findViewById(R.id.weight_txt_update);
        ...
        weight_txt_update.setText(user.getString(5));
        ...
        update_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ,password_txt_update.getText().toString(),Integer.parseInt(age_txt_update.getText().toString()),
                        Double.parseDouble(height_txt_update.getText().toString()),Double.parseDouble(weight_txt_update.getText().toString()),
                        gender);
